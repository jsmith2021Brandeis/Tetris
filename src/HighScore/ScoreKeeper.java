 ...
 * a local file Bugs: I have no idea why I need to use line sepearor here but nowhere else?
 *  Source: file writing
...
public static void main (String []args) {
	//prints decoded scores to console
	...
	private void loadHighScores() {
		// if the reader hasn't been intialized do nothing, such as if there is no source
		// yet
		if (reader == null) {
			return;
		}
